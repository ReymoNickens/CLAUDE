  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-background px-6">
      <div className="mb-8 text-center">
        ...
        <h1 className="text-2xl font-bold text-[#003087]">Welcome back</h1>
        <p className="mt-1 text-sm text-muted-foreground">Sign in to CampusConnect UCC</p>
      </div>
      ...
      <div className="w-full max-w-sm space-y-4">
        ...
        <p className="text-center text-sm text-muted-foreground">
          ...
          <Link href="/register" className="font-medium text-[#003087] hover:underline">
            Register
          </Link>
        </p>
      </div>
